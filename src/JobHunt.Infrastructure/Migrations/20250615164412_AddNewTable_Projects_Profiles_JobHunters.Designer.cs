...
namespace JobHunt.Infrastructure.Migrations
{
    ...
    [Migration("20250615164412_AddNewTable_Projects_Profiles_JobHunters")]
    partial class AddNewTable_Projects_Profiles_JobHunters
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobHunt.Core.Domain.Entities.Profile", b =>
                {
            ...
            modelBuilder.Entity("JobHunt.Core.Domain.Entities.Profile", b =>
                {
                    b.HasOne("JobHunt.Core.Domain.Entities.JobHunter", "JobFinder")
                        .WithOne("Profile")
                        .HasForeignKey("JobHunt.Core.Domain.Entities.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("JobFinder");
                });
