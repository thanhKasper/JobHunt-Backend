...
namespace JobHunt.Infrastructure.Migrations
{
    ...
    [Migration("20250616124221_ChangeNavigationProp")]
            ...
            modelBuilder.Entity("JobHunt.Core.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<Guid>("ProjectOwnerJobHunterId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProjectOwnerJobHunterId");
            ...
            modelBuilder.Entity("JobHunt.Core.Domain.Entities.Project", b =>
                {
                    b.HasOne("JobHunt.Core.Domain.Entities.JobHunter", "ProjectOwner")
                        .WithMany("Projects")
                        .HasForeignKey("ProjectOwnerJobHunterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
